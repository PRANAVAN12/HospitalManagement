...
$result2 = mysqli_query($mysqli,"SELECT * FROM doctors where username='$username' ");
}
...
<?php include '../../../View/headers/newuser.html';?>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active"><a href="List.php">Doctors</a></li>
								</ul>
							</div>
						</div>
					</div>
    ...
    <input type="text" name="username" class="form-control" placeholder="Search doctor ">
...
while($res = mysqli_fetch_array($result2)) { 
	...
	echo"														<a  class='avatar avatar-sm mr-2'><img class='avatar-img rounded-circle' src='../uploads/".$res['image']."' ></a>";
	echo"														<a>".$res['username']."</a>";
	echo"													</h2>";
	echo"												</td>";
