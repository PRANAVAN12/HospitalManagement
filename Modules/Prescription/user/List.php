...
$result = mysqli_query($mysqli, "SELECT * FROM prescription WHERE username = '$user'"); // using mysqli_query instead
...
$result2 = mysqli_query($mysqli,"SELECT * FROM prescription where doctor='$username' ");
}
